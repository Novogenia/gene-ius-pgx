...
| Version | Was |
|---|---|
| v88 | ~~Einfach / Experte umschaltbar~~ — **am 25.8.2026 auf Wunsch wieder zurückgenommen** („Ich brauche keinen einfachen Expertenmodus"). Der Bau liegt in Commit `fc9b7bf`, die Rücknahme in dessen Revert; wer die Trennung je wieder will, findet dort Mechanik und Einteilung fertig. |
...
| v86 | Hinzufüge-Knopf sitzt als Fußzeile IN der Medikamentkarte statt darunter |
...
| v81 | Deine Medikamente zeigt oben nur die Liste, Bewertung und Erklärung darunter; Hinzufügen über ein Popup mit Suche und Filtern |
| v80 | Suche wandert in die Medikamentliste, Deine Medikamente wird reine Liste; Drag and Drop entfernt |
...
| v75 | Alarm aus Genetik und Alarm aus Wechselwirkung getrennt: Etikett `INTERAKTION` mit Blitzsymbol; Bilanz ohne Doppelzählung |
| v74 | Bilanz als eine Reihe inkl. Wechselwirkungen; Arztbericht mit allen 471 übrigen Genen und größerer Überschrift; Statuszeile in Phänotypfarbe; Ursache der Ampelstufe benannt |
